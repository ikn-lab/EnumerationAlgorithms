        ...
        for j in types:
            ...
            for k in files:
                ...
                if margin - num_column < 0:
                    ...
                    message = subprocess.check_output("ls", shell=True)
                    if str(message).find("org/org_" + k) == -1:
                        subprocess.call("mkdir org", shell=True)
                        subprocess.call("mv " + k + " org/org_" + k, shell=True)
                    f = open(k, "w")
